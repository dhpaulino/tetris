...
namespace tetris{
  ...
  */
  constexpr int TYPE_TO_CELL(int x){
     return x+1;
  }
  /*
    Strings for how you would print a tetris board.
  */
  constexpr char TC_EMPTY_STR = ' ';
  // constexpr std::string_view TC_BLOCK_STR = "\u2588";

  /*
    Questions about a tetris cell.
  */
  constexpr bool TC_IS_EMPTY(char x){
    return (x) == TC_EMPTY;
  }
  constexpr bool TC_IS_FILLED(char x){
  ...
  */
  constexpr unsigned short TETRIS = 4;
  /*
    How many tetrominos?
  */
  constexpr unsigned short NUM_TETROMINOS = 7;
  /*
    How many orientations of a tetromino?
  */
  constexpr unsigned short NUM_ORIENTATIONS = 4;

  /*
    Level constants.
  */
  constexpr unsigned short MAX_LEVEL = 19;
  constexpr unsigned short LINES_PER_LEVEL = 10;
